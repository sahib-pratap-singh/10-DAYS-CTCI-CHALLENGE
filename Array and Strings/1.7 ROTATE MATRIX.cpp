// My approaches for **1.7 ROTATE MATRIX**

//1st approach and really easy
//Take the transpose of the matrix and reverse every row
//Time complexity: O(rows+cols) for transpose and 
//O(rows+cols) for reverse rows so total TC O(N)
...
//2nd approach and efficient 100% faster, only three swaps :slight_smile:
//Literally today i understand this, little tricky
